...
from app.ui.toolsWindow.externalRfidTag.external_rfid_button_ui import create_button_layout
# Import the function to update field write access based on vehicle type
from app.services.tools.externalRegistration.update_fields_write_access import update_fields_write_access
