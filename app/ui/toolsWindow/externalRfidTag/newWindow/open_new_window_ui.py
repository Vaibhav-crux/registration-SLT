...
from app.services.tools.externalRegistration.newServices.autofill_total_amount_service import calculate_total_amount
from app.services.tools.externalRegistration.newServices.paymentServices.upi_payment_service import show_upi_payment_dialog
