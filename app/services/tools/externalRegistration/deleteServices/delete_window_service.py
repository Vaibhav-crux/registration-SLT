...
from app.utils.mode_utils import apply_mode_styles, apply_window_flags,set_dark_mode_title_bar,is_dark_mode
...
from app.ui.toolsWindow.externalRfidTag.deleteWindow.delete_window_ui import setup_delete_window_ui
...
class DeleteWindow(QDialog):
    def __init__(self, rfid_tag, vehicle_no,parent=None):
...
def open_delete_window(rfid_tag, vehicle_no,parent=None):
    dialog = DeleteWindow(rfid_tag, vehicle_no,parent)
    dialog.exec_()
